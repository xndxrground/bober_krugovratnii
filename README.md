...
PseudoFS – простая псевдо-файловая система на C
    ...
    PseudoFS – учебный проект, демонстрирующий работу с самописным плоским файлом-“диском” и консольной утилитой-клиентом. Он позволяет создавать, удалять, читать и обновлять файлы в одиночном контейнере disk.filesystem с чрезвычайно простым текстовым форматом.
